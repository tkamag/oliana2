...
description: >-
  ...
  https://hackthebox.eu
title: Certified Data Analytics - Specialty                    # Add title of the machine here
date: 2023-02-02 08:00:00 -0600                           # Change the date to match completion date
categories: [AWS Certification Cheatsheet, AWS Certified Data Analytics - Specialty]                     # Change Templates to Writeup
tags: [AWS, Certification, CloudFront, Data, template]     # TAG names should always be lowercase; replace template with writeup, and add relevant tags
